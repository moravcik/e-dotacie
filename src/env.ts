...
const DEFAULT_XPATH_PDF_LABEL = 'string(/html/body/section[2]/div/article/div/ul/li[20]/ul/li[22]/a/div/text())';
const DEFAULT_XPATH_PDF_URL = 'string(/html/body/section[2]/div/article/div/ul/li[20]/ul/li[22]/a/@href)';
